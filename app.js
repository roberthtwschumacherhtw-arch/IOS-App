...
let db = {exercises:[...DEFAULT_EX], workouts:[], body:[], splits:[], exGroups:{}, exNotes:{}, customBarcodes:{}, sex:'m', age:null, height:null, n8nUrl:'', mealTypes:[...DEFAULT_MEALS], goals:{...DEFAULT_GOALS}, foodFav:[], nutrition:{...DEFAULT_NUTRITION}};
...
function renderNutri(){
  ...
  if(box){
    ...
    // "zu wenig Daten" → springt zur Profil-Karte und fokussiert das erste leere Feld
    const _tp=box.querySelector('#toProfile'); if(_tp) _tp.onclick=()=>{
