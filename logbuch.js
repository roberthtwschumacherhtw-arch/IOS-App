...
trainOv.querySelector('.atsave').onclick = ()=>{ closeAT(); const sb=$('#saveW'); if(sb) sb.click(); };
...
function renderResumeBar(){
  ...
  // Der alte Timer-Kasten wuerde sonst daneben schweben
  const tt=$('#trainTimer'); if(tt && zeigen) tt.style.display='none';
  if(!zeigen) return;
